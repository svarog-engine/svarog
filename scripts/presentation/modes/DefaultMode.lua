...
Glossary.Default = {
	...
	furnace = { x = 22, y = 1, fg = Colors.Black, bg = Colors.LightRed },
	...
	phantasm = { x = 16, y = 1, fg = Colors.DarkGray, bg = Colors.Red },
	...
	skeleton = { x = 7, y = 3, fg = Colors.Gray, bg = Colors.Black },
	restless = { x = 18, y = 11, fg = Colors.DarkRed, bg = Colors.Black },
